...
### Arthur: Henry Chung(鍾承翰), Eric Chen(陳景寬), 范伯綱, Patrick Wu(吳欣澤)
...
- Custom trading environment (`trading_env.py`) [trading_env Repository](https://github.com/ericchen1121/gym-futures-trading/tree/master)
